...
namespace LIVROCSHARP
{
    class conversaoDados
    {
        static void Main(string[]args)
        {
            ...
            WriteLine($"objeHoje:{objHoje} - {objHoje.GetType()}");
            ...
            WriteLine("-----Unboxig");
                ...
                WriteLine($"obj Desconto:{objDesconto} - {objDesconto.GetType()}");
            ...
            try
            {
                ...
                //reotna 200 mesmo com os espaçõs em branco antes e depois
