...
namespace LIVROCSHARP
{
    class funcoesDatas
    {
        static void  Main(string[] args)
        {
            ...
            WriteLine("DAY / MONTH / YEAR - Captura o dia , mês e ano separadamente");
            ...
            WriteLine($"Entre o pedido de o pagamento foram {qtdeDias:dd}dias");
            ...
            DateTime dataTextoErradoConvertida;

            if(DateTime.TryParse(dataTextoErrada, out dataTextoErradoConvertida))
                WriteLine("Data com conversão aceita");
            else
                WriteLine("Erro na conversão da data");
